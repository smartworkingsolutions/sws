	...
	while ( $query->have_posts() ) :
		...
		<div class="flex flex-col justify-between bg-white rounded-xl">
			...
			<div>
				...
				<?php
				printf(
					'<a class="flex justify-center items-center gap-5 text-text-color text-lg font-bold uppercase border-t border-border-color hover:bg-blue-dark hover:text-white hover:fill-white rounded-b-20 px-7 py-5 mt-5" href="https://smartworking-solutions.com/book-a-chat/">%s%s</a>',
