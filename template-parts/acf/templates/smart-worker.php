...
<section class="w-full">
	<div class="container">
		...
		echo '<div class="columns-1 md:columns-2 xl:columns-3 gap-8 mt-10 md:mt-14">';
		...
		while ( have_rows( 'add_cards' ) ) :
			...
			echo '<div class="text-white rounded-10 pt-5 pb-7 px-8 mb-8 break-inside-avoid' . esc_html( $bg_colors ) . '">';

			echo '<h3 class="text-3xl">' . esc_html( $card_title ) . '</h3>';

			echo '<ul class="grid gap-3 mt-10">';
