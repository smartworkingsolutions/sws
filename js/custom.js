jQuery(document).ready(function() {
	...
	// Show images on hover in Hero banner.
	jQuery('.hero-images').hover( function() {
		jQuery(this).find('div').addClass('opacity-30');
	});
